...
def gen_api_init_files(
        ...
        packages = ["keras"],
        package_deps = ["//third_party/py/keras:keras"],
    ...
    native.py_binary(
        ...
        srcs = ["//third_party/py/keras/api:create_python_api_wrapper.py"],
        main = "//third_party/py/keras/api:create_python_api_wrapper.py",
        python_version = "PY3",
